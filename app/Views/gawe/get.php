                        ...
                        <?php foreach ($gawe as $key => $value) : ?>
                            <tr>
                                ...
                                <td class="text-center" style="width: 15%;">
                                    ...
                                    <form action="<?= site_url('gawe/' . $value->id_gawe) ?>" class="d-inline" method="post" id="del-<?=$value->id_gawe ?>">
                                        <?= csrf_field(); ?>
                                        <input type="hidden" name="_method" value="DELETE">
                                        <button href="" class="btn btn-danger btn-sm" data-confirm="Hapus Data?|Apakah Anda Yakin?" data-confirm-yes="submitDel(<?=$value->id_gawe?>)"><i class="fas fa-trash"></i></button>
                                    </form>
